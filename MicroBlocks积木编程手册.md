...
## ![设置用户LED.png](/assets/设置用户LED_1671075434964_0.png)**设置用户LED** 
...
程序源码：[code_setuserled.ubp](/assets/code_setuserled_1671075883829_0.ubp ':ignore')

- 


## ![说.png](/assets/说_1671114441273_0.png) **说**
...
![计算10x2](/assets/sayresult.png)

- 


## ![绘图.png](/assets/绘图_1671089321175_0.png)**绘图**
将在数据绘图显示面板中对输入的数值进行绘图。任何类型的数据都可以被绘制成图表：数字、数字引脚输入和模拟引脚输入、传感器输出等。如果要绘制一个以上的数据字段，请点击黑色三角形的附加数据字段。可以用不同的颜色绘制多达六个同时出现的数值。

注意：绘图只在 IDE 中支持。因此，只有当微型设备连接到计算机时，才有可能作图。在没有连接到电脑的情况下试图作图将导致显示 "未连接主板" 的信息。
...
### **数据图表面板**
![image.png](/assets/image_1671090701013_0.png)
...
## ![按键 A.png](/assets/按键_A_1671190608839_0.png)**按键 A**
...
![buttonA](/assets/buttonA.png)


- 


## ![buttonB](/assets/buttonB.png)**按键 B**
...
## ![计时器.png](/assets/计时器_1671190763021_0.png)**计时器**
返回微型设备连接到USB端口后的毫秒数（从0ms开始）。
无论程序的启动/停止状态如何，定时器都会递增。为了得到一个零的起始点，请使用**计时器归零积**木块。
...
## ![计时器归零.png](/assets/计时器归零_1672032768402_0.png)**计时器归零**
将程序计时器重置为零。
- 举例
...
## ![毫秒.png](/assets/毫秒_1672032951596_0.png)**毫秒**
返回微型设备连接到USB端口后的毫秒数（从0ms开始）。
...
## ![微秒.png](/assets/微秒_1672033002155_0.png)**微秒**
...
## ![主板类型.png](/assets/主板类型_1672033175486_0.png)**主板类型**
...
![image.png](/assets/image_1672033070943_0.png)

程序显示它所运行的微型设备的类型。

# 引脚 PINS <div style="background-color:#548799; height:10px;width: 10px;display:inline-block"></div>
## ![读取数字引脚.png](/assets/读取数字引脚_1671177981562_0.png)**读取数字引脚**
...
![读取数字引脚程序实例.png](/assets/读取数字引脚程序实例_1671178084772_0.png) 
![Data Graph read digital](https://imgs.zhubai.love/ba9c4fa8209847359ac02395c9414d15.png)

- 


## ![读取模拟引脚.png](/assets/读取模拟引脚_1671178487806_0.png)**读取模拟引脚**
...
![读取模拟引脚程序实例.png](/assets/读取模拟引脚程序实例_1671179345153_0.png)
![](https://imgs.zhubai.love/064a04d156c64ca2aea5f0bbed2800ea.png)

## ![设置数字引脚.png](/assets/设置数字引脚_1671180237159_0.png)**设置数字引脚**
...
## ![设置引脚.png](/assets/设置引脚_1672033532402_0.png)**设置引脚**
...
## ![模拟引脚.png](/assets/模拟引脚_1672033661188_0.png)**模拟引脚**
...
## ![数字引脚.png](/assets/数字引脚_1672033797622_0.png)**数字引脚**
...
## ![当启动时.png](/assets/当启动时_1671368618055_0.png)**当启动时**
帽子积木是在控制分组中，当点击绿色的开始 ![](https://wiki.microblocks.fun/reference_manual/common/runicon.png)  图标时开始运行。这些帽子积木监控着它们标题中描述的各种条件。当程序启动条件为真时，**当启动时**这个特殊的积木块就会激活。其他的则是检查按钮状态或布尔条件是否为真，然后再执行放在它们下面的积木。
...
## ![当按键A被按下.png](/assets/当按键A被按下_1671369242903_0.png)**当按键被按下**
...
![](https://wiki.microblocks.fun/reference_manual/control/code_whenb2.png)

- 


## ![重复执行.png](/assets/重复执行_1671370036119_0.png)**重复执行**
...
## ![重复几次.png](/assets/重复几次_1671370209645_0.png)**重复几次**
这个C形状积木块重复执行给定数值次数。

- 举例

该程序通过重复 5 次来计算前5个数字的总数。在每一次重复中，变量 num 增加 1 并加入到变量total 中。最后，total 存储的结果是1+2+3+4+5=15。
使用 **说** 和 **滚动显示文字** 积木显示总数 total。

## ![等待毫秒.png](/assets/等待毫秒_1671371399929_0.png)**等待 毫秒**
...
## ![如果.png](/assets/如果_1671372287475_0.png)**如果**
...
![code如果.png](/assets/code如果_1671372220015_0.png)

- 


## ![当when.png](/assets/当when_1671372961793_0.png)**当**
当 WHEN 帽子积木运行时，它重复检查一个布尔条件。当条件为真时，帽子下的块被运行。如果条件在执行结束时仍然为真，那么这些块将被再次运行，这个过程重复进行，直到条件变为假。
注意：WHEN **当**帽子积木包括周期之间10毫秒的等待。这对去掉嘈杂的输入（如按钮）很有帮助，但将性能限制在每秒钟最多100次的迭代。要处理更高速的事件，请在FOREVER循环中使用IF语句。
- 举例
...
![codewhen当.png](/assets/codewhen当_1671373231624_0.png)


- 


## ![直到 ...前都等待.png](/assets/直到_...前都等待_1671525201919_0.png)**直到 ...前都等待**
...
## ![返回.png](/assets/返回_1671690034765_0.png)**返回**
返回（RETURN） 积木用于报告在其输入区中指定的数值。这可以是任何数据类型。虽然可以在程序的任何地方使用 返回 （RETURN） 积木来显示一个值，类似于**说**（SAY） 积木，但它的正确和更常见的用途是在一个函数（或报告者类型的自定义积木）中返回一个值，作为那里的处理结果。返回一个值的自定义积木因此被称为报告积木 REPORTER。注意，放在返回 RETURN 积木之后的块不会被执行。
...
另一个 当 WHEN 积木监测相反的情况，即当真值没有返回时。在这种情况下，程序会显示一条信息，表明当前的温度。
要测试该程序，只需用手指夹住微型设备处理器，让其温度根据你的体温上升。或者在传感器区域施加一个小的热源。

![code这很热.png](/assets/code这很热_1671691158213_0.png)
...
## ![当接收到.png](/assets/当接收到_1671691863785_0.png)**当接收到**
...
这个积木块通常与**广播**BROADCAST积木一起使用，以实现程序内的通信手段。任何用广播 BROADCAST 指令发送的消息都会通过当接收到积木块检测和接收。因此，放置在这个块下的块将在接收到相应的消息后运行。消息可以是字符串，也可以是数字。另外，最新消息 LAST MESSAGE 积木块包含了最新从广播中接收的信息。

- 


## ![广播.png](/assets/广播_1671791978400_0.png)**广播**

见上面的**当接收到**。广播积木将指定的消息内容发送至程序上下文。所有接收处理相同消息内容的 “当接收到” 消息积木都将收到该消息并对其采取行动。

- 举例

这个例子利用了控制类别中所有与消息相关的块。当点击 START 时，程序等待2秒，然后发送 "测试 "消息。当接收到消息 WHEN RECEIVED 积木块正在监视消息，并特别寻找 "test"消息。当收到 test 消息时，将运行它下面的块。收到的信息将在主控板的LED屏上滚动显示，并在 IDE 中显示。
...
## ![注释.png](/assets/注释_1672128311681_0.png)**注释**

这是一个简单的块，不做任何特别的事情。它被用来在程序块序列中放置注释。


## ![从数字序列.png](/assets/从数字序列_1672126740656_0.png)**从 ... 到 ... 到数字列表**

创建一个数字序列，可以用于迭代。可选间隔参数。

- 举例

生成一个从1到10 间隔为2 的数字序列。 

![间隔.png](/assets/间隔_1672126903603_0.png)

- 


## ![for循环积木.png](/assets/for循环积木_1672044791693_0.png)**重复执行 变化因子** 
...
![for循环1.png](/assets/for循环1_1672044698916_0.png) 
![for循环2.png](/assets/for循环2_1672044714099_0.png)
...
## ![重复执行直到.png](/assets/重复执行直到_1672043876983_0.png)**重复执行 直到**
...
![等待直到1.png](/assets/等待直到1_1672043682748_0.png) ![image.png](/assets/image_1672043661650_0.png)


- 


## ![stopthis积木.png](/assets/stopthis积木_1672127915741_0.png)**停止当前任务**
...
## ![stoopothers.png](/assets/stoopothers_1672128205838_0.png)**停止其他任务**
...
## ![等待微秒.png](/assets/等待微秒_1672128611357_0.png)**等待 微秒**
...
## ![最新消息.png](/assets/最新消息_1672128810684_0.png)**最新消息**
...
![消息代码.png](/assets/消息代码_1672130147527_0.png)

- 


## ![调用指令.png](/assets/调用指令_1672128489412_0.png)**调用（指令）**

- 


## ![调用报告.png](/assets/调用报告_1672128509143_0.png)**调用（报告）**

- 


# 运算 OPERATORS  <div style="background-color:#52a528; height:10px;width: 10px;display:inline-block"></div>
## ![加.png](/assets/加_1672553641184_0.png)**加 +**
...
## ![减.png](/assets/减_1672553671587_0.png)**减 -** 
...
## ![乘.png](/assets/乘_1672553695716_0.png)**乘 x**
...
## ![除.png](/assets/除_1672553723760_0.png)**除 /**
...
## ![mod.png](/assets/mod_1672486336543_0.png)**模数取余 /**
...
## ![绝对值.png](/assets/绝对值_1672554132263_0.png)**绝对值**
...
## ![最小值.png](/assets/最小值_1672554377553_0.png)**最小值**
...
## ![最大值.png](/assets/最大值_1672554154671_0.png)**最大值**
...
## ![随机数.png](/assets/随机数_1672554453668_0.png)**在 ... 到 ... 之间取随机数**
...
## ![小于.png](/assets/小于_1672554539447_0.png)**小于 <**
...
## ![小于等于.png](/assets/小于等于_1672554617284_0.png)**小于等于 <=**
...
## ![等于.png](/assets/等于_1672554782679_0.png)**等于 =**
...
## ![不等于.png](/assets/不等于_1672557042471_0.png)**不等于** 
...
## ![大于等于.png](/assets/大于等于_1672556541170_0.png)**大于等于 >=**
...
## ![大于.png](/assets/大于_1672557203323_0.png)**大于 >**
...
## ![布尔常量.png](/assets/布尔常量_1672554912480_0.png)**布尔常量 true/false**
...
## ![不成立.png](/assets/不成立_1672555807587_0.png)**非 （不成立）**
反转与它所操作的布尔值的逻辑值。
...
一个名为 string 的局部变量被设置为 "MicroBlocks is great"，一个名为 expression 的局部变量被设置为 "length of string = length of string"。
表达式的布尔值显然是真 TRUE。
...
## ![且.png](/assets/且_1672555922982_0.png)**与**
...
## ![或.png](/assets/或_1672555941070_0.png)**或**
...
## ![类型是.png](/assets/类型是_1672555965732_0.png)**类型是**
...
## ![convert](/assets/convert.png)**转换为**

返回左侧的输入表达式，转换为右侧所选的数据类型的值。

编程时数据类型很重要。虽然像 MicroBlocks 这样的环境可以让初学者轻松处理任何数据类型转换，但在比较值看起来相同的变量时，仍然可能在视觉上被欺骗。该块将帮助您在 MicroBlocks 支持的任何对象类型之间进行转换。

|TYPE 类型|DESCRIPTION 描述|VALUES 取值|COMMENTS 评论|
|-|-|-|-|
|Booleans 布尔值|表示值 true 和 false|true: 0 以外的值， false: 0| |
|Integers 整数|存储带符号的 31 位二进制补码值|-1073741824至1073741823| |
|Byte Arrays 字节数组|存储无符号 8 位整数值|0 - 255| 大小固定，不能动态增长|
|Strings 字符串|字符串是用于存储单词或字符的序列纯文本。字符可能是某个字母表中的字母，数字、空格、标点符号等。字符存储为 UTF-8 编码的 Unicode 代码点。|十六进制：U+0000 - U+10FFF 十进制：0 - 69631| 前 128 个 UTF-8 代码点对应到 ASCII 字符集|
|Lists 列表|存储上面列出的任何对象 | | |
...
## ![十六进制.png](/assets/十六进制_1672556640549_0.png)**16进制 hex**
...
![colorhex.png](/assets/colorhex_1672542037502_0.png)
![codeHEX.png](/assets/codeHEX_1672542095606_0.png)
![neoPixel.png](/assets/neoPixel_1672542152287_0.png)



## ![位与.png](/assets/位与_1672557337389_0.png)**位与 &**
...
## ![位或.png](/assets/位或_1672556184321_0.png)**位或 ｜**
...
## ![异或.png](/assets/异或_1672556195941_0.png)**位异或 ^**
...
## ![位非.png](/assets/位非_1672556225433_0.png) **位非**
...
## ![位左移.png](/assets/位左移_1672556338248_0.png)**位左移**
...
### ![右移.png](/assets/右移_1672556366450_0.png)**右移 （算数右移）**
...
## ![映射2.png](/assets/映射2_1672556455073_0.png)**映射**
...
## ![新建一个变量](/assets/image_1671776446326_0.png)**新建一个变量**

这个块实际上是一个按钮。它创建了一个新的全局变量。
如果有一个同名的变量存在，新的变量将以相同的名称创建，并附加数字2。
例如：名字为test的变量存在。另一个变量以同样的名字被创建。新变量的名字变成了test2。
- 举例
![image.png](/assets/image_1671776313720_0.png)
![image.png](/assets/image_1671776385354_0.png)

- 


## ![删除一个变量](/assets/image_1671777514875_0.png)**删除一个变量**

实际上这是一个按钮。至少有一个变量已经被创建才会显示，通常是不显示的。一旦创建了一个变量，这个按钮就可以用来删除它。
- 举例
下面两张图片描述了变量的删除过程。

![image.png](/assets/image_1671776681570_0.png)

当点击“删除一个变量按钮”时，会出现一个所有全局变量的列表。这里是要删除的变量“测试数据”。它被选中并被点击。


## ![赋值变量1.png](/assets/赋值变量1_1671786935527_0.png)**把 ... 变量设定为 ...**

这个积木用来给变量赋值。它的选择菜单将显示所有全局变量和局部变量的列表。

![设置变量.png](/assets/设置变量_1671786516582_0.png)

为了在选择菜单中显示局部变量的名称，这个块必须被物理地连接到使用“将局部变量初始化”积木的块序列中。
...
## ![将变量增加](/assets/改编变量_1671788285251_0.png)**将变量增加**

该积木按输入区给定的数值改变某个全局变量或局部变量的值。输入的数值可以是一个正数或负数。
- 举例
该程序改变了两个变量：全局变量 test 和局部变量 var 的值。
...
## ![localvar](/assets/localvar.png)将局部变量变量初始化为

该积木块用于创建和初始化局部变量。

默认的变量名称var可以通过点击该名称并在打开的对话框中输入新的名称来改变为其他名称。

创建完成局部变量后，如果需要改变局部变量var的值，可以使用变量类别中的**变量设定为**积木。

### 全局与局部变量
- 一个全局变量具有下面的特点：
    1. 全局范围：一个全局变量可以在任何没有同名局部变量的脚本中使用，而这些局部变量又没有覆盖它。
...
- 与此相反，局部变量具有以下特点：
    ...
    3. 优先于全局变量：如果一个局部变量与一个全局变量有相同的名字，那么在局部变量出现的脚本中，局部变量会优先于全局变量。无论 "将局部变量 var 初始化为"出现在脚本的什么地方，该变量在整个脚本中都是局部变量（尽管 "将局部变量 var 初始化为 "出现在对该变量的任何其他引用之前是很好的编码实践）。
...
## ![item.png](/assets/item_1672360113631_0.png)**第几项**
...
## ![length.png](/assets/length_1672361229993_0.png)**长度**
...
## ![join.png](/assets/join_1672361627389_0.png)**连接**
...
## ![listcreate.png](/assets/listcreate_1672362934855_0.png)**列表**
...
## ![addlist.png](/assets/addlist_1672366302856_0.png)**添加项目至列表**
...
## ![replace替换.png](/assets/replace替换_1672367221787_0.png)**替换项**
...
## ![deleteitem.png](/assets/deleteitem_1672367952893_0.png)**删除项**
...
## ![查找.png](/assets/查找_1672468262339_0.png)**查找**
...
- 举例
    ...
    局部变量 string 和 animals分别被初始化为string和list类型。
...
## ![复制.png](/assets/复制_1672468814612_0.png)**复制**
...
## ![split.png](/assets/split_1672380162504_0.png)**分割**
...
## ![joinlist.png](/assets/joinlist_1672383281657_0.png)**连接列表中的项目**
...
## ![unicode.png](/assets/unicode_1672471752374_0.png)**unicode**
...
## ![unicodenum.png](/assets/unicodenum_1672472056370_0.png)**unicode 对应字符**
...
## ![newlist.png](/assets/newlist_1672473997198_0.png)**新建列表**
...
## ![newbytearray.png](/assets/newbytearray_1672474733380_0.png)**新建字节数组**
...
## ![asbytearray.png](/assets/asbytearray_1672475283988_0.png)**作为字节数组**
...
## ![闲置内存.png](/assets/闲置内存_1672478742072_0.png)**闲置内存**
...
## ![新建命令积木](/assets/image-109.png)**新建命令积木**
...
![自定义积木编辑视图.png](/assets/自定义积木编辑视图_1671948313757_0.png)
...
![image.png](/assets/image_1671948704040_0.png)
...
![image.png](/assets/image_1671949153142_0.png)

因此，根据你的意图，你可能发现一种方法或另一种方法更适合你的需要。
要重新命名一个参数，点击棕色的椭圆形参数区，在编辑窗口中输入一个新的名称。

![image.png](/assets/image_1671949215503_0.png)

### 创建自定义积木的过程
- **指定一个自定义块的名称**
当点击**新建积木**按钮时，会打开一个对话框，输入自定义块的名称。

![image.png](/assets/image_1671949960466_0.png)

点击 "确定 "按钮后，一个自定义块定义的标题就被放置在编程区。

![image.png](/assets/image_1671950031179_0.png)

现在，构成这个自定义积木的所有代码块都可以放在帽子积木下面，它们将成为新函数脚本的一部分。还要注意的是，一个代表自定义功能的新寂寞已经被放入 " "类别窗口，默认名称为myBlock。这个默认名称可以改变。请参考通用操作。
- **添加参数和它们的标签**
...
注意，这个函数的名字看起来像“ 字符串”。事实上，函数名是。“字符串”是第一个参数的名称。然而，由于MicroBlocks通常不允许在标签后面输入标签，因此有必要先创建参数“我的名字”，然后双击函数名“”，并在其后面加上" 字符串"（空格字符串）。
...
## ![新建报告积木](/assets/image-110.png)**新建报告积木**
...
## ![i2c读取寄存器.png](/assets/i2c读取寄存器_1672727311733_0.png)**I2C 读取设备 寄存器**

返回给定I2C设备（0-127）的给定寄存器（0-255）的值。检查I2C设备的数据表，了解设备地址和寄存器的分配情况。
如果成功，该块返回一个正的8位值（0-255）。负的返回值表示一个错误，如I2C没有响应。


## ![i2c设置寄存器.png](/assets/i2c设置寄存器_1672727411415_0.png)**I2C 设置设备 寄存器**

将一个8位字节（0-255）写入给定的I2C设备的寄存器。


## ![i2c读取列表.png](/assets/i2c读取列表_1672727533023_0.png)**I2C 读取列表**

从给定的I2C设备接收多个字节。调用者提供一个列表，其长度为要读取的字节数。如果成功，该操作将用从设备中读取的字节替换该列表中的项目。


## ![i2c写入列表.png](/assets/i2c写入列表_1672727550332_0.png)**I2C 写入列表**

向指定的I2C设备发送多个字节。该列表应包含范围为0-255的整数。


## ![spi发送.png](/assets/spi发送_1672727875717_0.png)**spi 发送**

向 spi 设备发送一个字节（0-255）。
SPI 硬件同时发送和接收数据。在每个时钟脉冲上，从 SPI 输入线上读取一个比特，同时在SPI输出线上输出一个比特。在发送字节时，该块会丢弃从 SPI 总线上收到的字节。


## ![spi接收.png](/assets/spi接收_1672727941795_0.png)**spi 接收**

从SPI设备中读取一个字节，同时发送一个零字节，并返回收到的字节。


## ![spi设置速率.png](/assets/spi设置速率_1672728060596_0.png)**spi 设置速率**

设置 spi 传输速率


## ![spi交换字节.png](/assets/spi交换字节_1672728174548_0.png)**spi 交换数据**

spi 传递字节数组


## ![串口打开.png](/assets/串口打开_1672728286173_0.png)**串口打开**
...
## ![串口关闭.png](/assets/串口关闭_1672728305870_0.png)**串口关闭**

关闭并终止串口通信。


## ![串口读取.png](/assets/串口读取_1672728424316_0.png)**串口读取**
...
## ![串口写入.png](/assets/串口写入_1672728484220_0.png) **串口写入**
...
## ![串口写入开始于.png](/assets/串口写入开始于_1672728869553_0.png)**串口写入开始于**
...
## ![软串口写入.png](/assets/软串口写入_1672728939927_0.png)**软串口写入在给定引脚**

用设定的速率在给定引脚写入数据到模拟串口。

> 积木块类别采用颜色编码以便于识别。仅当选择“显示高级块”时，标记为“高级”的部分中的块才可见。
